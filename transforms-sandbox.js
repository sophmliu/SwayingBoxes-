...
export class Transforms_Sandbox extends Transforms_Sandbox_Base {
    ...
    display(context, program_state) {
        ...
        const blue = hex_color("#1a9ffa"), yellow = hex_color("#fdc03a"), red = hex_color("#ff0000")
        ...
        this.shapes.square.draw(context, program_state, model_transform, this.materials.plastic.override(red));
